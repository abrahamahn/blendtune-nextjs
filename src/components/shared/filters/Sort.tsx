...
const SortFilter: React.FC<SortFilterProps> = ({
  ...
  return (
    <div>
      {openSortFilter && (
        <div className="hidden md:block z-20 absolute mt-2 right-30 w-28 bg-white/95 dark:bg-black/90 border border-neutral-200 dark:border-neutral-700 px-2 shadow rounded-lg text-neutral-300 text-xs">
          <div
            className="py-2"
            role="menu"
