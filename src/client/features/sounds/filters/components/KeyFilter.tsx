...
const KeyFilter: React.FC<KeyFilterProps> = ({
  ...
  useEffect(() => {
    ...
    const generateKeyCombinations = (
      ...
      // Helper function to add a combination only if it's not already seen
      ...
      if (selectedKeys) {
        // Add the selected key with its relative scale combinations
        ...
        // Add the equivalent key combinations
        const equivalentKey =
