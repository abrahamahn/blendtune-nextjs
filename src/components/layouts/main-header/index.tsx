...
const Header: React.FC = () => {
  ...
  return (
    <header>
      <div>
        {/* Desktop Menu */}
        <nav className="hidden md:block items-center justify-between rounded-t-xl fixed top-2 page-header-width p-2 h-14 z-20 bg-neutral-100/80 dark:bg-black/50">
