...
/**
 * Shared props for the desktop/mobile mood selection lists, hoisted out of
 * MoodFilter so they aren't recreated as new component types on every render.
 */
 ...
 */
const DesktopMoodFilter: React.FC<MoodListProps & { onClose: () => void }> = ({
  searchTerm,
  onSearchTermChange,
  moods,
  selectedMoods,
 ...
 */
const MobileMoodFilter: React.FC<MoodListProps> = ({
  searchTerm,
  onSearchTermChange,
  moods,
  selectedMoods,
