...
import { selectKeyword, removeAllKeywords } from "@/redux/trackSlices/keyword";
  ...
  return (
    ...
    >
      <input
        ...
        onFocus={handleFocus}
        onBlur={handleBlur}
        className={`focus:outline-none w-full h-8 pl-4 pr-8 text-sm rounded-2xl text-black dark:text-neutral-200 bg-transparent border-transparent z-10`}
        placeholder="Search..."
        style={{
          outline: "none",
