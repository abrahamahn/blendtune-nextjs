// src\client\features\sounds\tracks\components\MobileCatalog.tsx
"use client";
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex flex-row ml-auto text-center text-2xs md:text-xs w-auto">
                  {renderValue(track.info.mood[0]) && (
                    <p className="px-1 cursor-pointer text-[#707070] hover:text-neutral-400 dark:text-neutral-300 dark:hover:text-white">
                      {renderValue(track.info.mood[0])}
                    </p>
                  )}
                  ...
                  {renderValue(track.info.mood[3]) && (
                    <p className="px-1 cursor-pointer text-[#707070] hover:text-neutral-400 dark:text-neutral-400 dark:hover:text-white">
                      {renderValue(track.info.mood[3])}
                    </p>
                  )}
                </div>
